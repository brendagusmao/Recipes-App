const TOMATO_PUREE = 'Tomato_Puree';
const MINCED_BEEF = 'Minced Beef';
const SPING_ONIONS = 'Spring Onions';
const GARLIC_CLOVE = 'Garlic Clove';
const VEGETABLE_OIL = 'Vegetable Oil';
const FINELY_CHOPED = '1 finely chopped ';
